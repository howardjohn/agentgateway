...
// MarshalJSON is a custom marshaler for AIBackend_Managed
func (this *AIBackend_Managed) MarshalJSON() ([]byte, error) {
	str, err := ResourceMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for AIBackend_Managed
func (this *AIBackend_Managed) UnmarshalJSON(b []byte) error {
	return ResourceUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
