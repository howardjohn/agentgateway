...
func NewAgwCollections(
	...
	gateways := krt.WrapClient(kclient.NewFilteredDelayed[*gwv1.Gateway](client, wellknown.GatewayGVR, filter), krtOptions.ToOptions("KubeGateways")...)
	...
	listenerSets := krt.WrapClient(kclient.NewDelayedInformer[*gwv1.ListenerSet](client, wellknown.ListenerSetGVR, kubetypes.StandardInformer, filter), krtOptions.ToOptions("KubeListenerSets")...)
