...
use typespec_client_core::http::{BufResponse, Sanitizer};
...
fn from_method(method: azure_core::http::Method) -> azure_core::Result<crate::http::Method> {
	match method {
		azure_core::http::Method::Get => Ok(crate::http::Method::GET),
		azure_core::http::Method::Head => Ok(crate::http::Method::HEAD),
		azure_core::http::Method::Post => Ok(crate::http::Method::POST),
		azure_core::http::Method::Put => Ok(crate::http::Method::PUT),
		azure_core::http::Method::Delete => Ok(crate::http::Method::DELETE),
		azure_core::http::Method::Patch => Ok(crate::http::Method::PATCH),
		_ => crate::http::Method::from_str(method.as_str())
			.map_kind(azure_core::error::ErrorKind::DataConversion),
	}
}
