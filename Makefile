...
refresh-model-catalog:
	go run ./controller/cmd/agctl catalog import --source models.dev,aws-bedrock-mantle,vertex-pricing --exclude-providers openrouter --overlay ./catalog/model-catalog-overrides.yaml --out ./catalog/model-catalog.json --pretty
