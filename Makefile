...
.PHONY: generate-apis
generate-apis:
	@PATH=./common/tools:$(PATH) buf generate --path crates/agentgateway/proto/resource.proto --path crates/agentgateway/proto/workload.proto.PHONY: run-validation-deps
