...
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)sse.backend`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)sse.backend.(1)service`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)sse.backend.(1)service.name`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)sse.backend.(1)service.name.namespace`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)sse.backend.(1)service.name.hostname`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)sse.backend.(1)service.port`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)sse.backend.(1)host`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)sse.path`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)mcp`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)mcp.backend`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)mcp.backend.(1)service`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)mcp.backend.(1)service.name`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)mcp.backend.(1)service.name.namespace`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)mcp.backend.(1)service.name.hostname`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)mcp.backend.(1)service.port`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)mcp.backend.(1)host`||
...
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)openapi.backend`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)openapi.backend.(1)service`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)openapi.backend.(1)service.name`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)openapi.backend.(1)service.name.namespace`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)openapi.backend.(1)service.name.hostname`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)openapi.backend.(1)service.port`||
|`binds[].listeners[].routes[].backends[].(1)mcp.targets[].(1)openapi.backend.(1)host`||
